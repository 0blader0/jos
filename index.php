...
<html style="font-size: 16px;" lang="cz"><head>
    ...
    <title>Signup</title>
    <link rel="stylesheet" href="jossignup.css" media="screen">
<link rel="stylesheet" href="signup.css" media="screen">
  ...
  <body data-path-to-root="./" data-include-products="false" class="u-body u-xl-mode" data-lang="cz"><header class="u-black u-clearfix u-header u-header" id="sec-0205"><div class="u-clearfix u-sheet u-valign-middle u-sheet-1">
        <a href="index.php" class="u-hover-feature u-image u-logo u-image-1" title="Domov" data-image-width="1008" data-image-height="1008">
    ...
    <div class="u-clearfix u-sheet u-valign-middle-sm u-valign-middle-xs u-sheet-1">
        <div class="u-align-center u-container-style u-custom-border u-custom-color-3 u-expanded-width-sm u-expanded-width-xs u-group u-opacity u-opacity-15 u-radius u-shape-round u-group-1">
            <div class="u-container-layout u-container-layout-1">
            <h2 class="u-text u-text-custom-color-3 u-text-default u-text-1">Přihlásit se</h2>
            <div class="u-expanded-width-xs u-form u-login-control u-form-1">
              <form action="#" class="u-clearfix u-form-custom-backend u-form-spacing-10 u-form-vertical u-inner-form" source="custom" name="form" style="padding: 0px;" method="post">
                <div class="u-form-group u-form-name u-label-top">
                  <label for="username-a30d" class="u-label u-text-custom-color-3 u-label-1">Přihlašovací jméno</label>
                  <input type="text" placeholder="Zadejte přihlašovací jméno" id="username-a30d" name="uname" class="u-border-2 u-border-grey-10 u-grey-10 u-input u-input-rectangle u-input-1" required="">
                </div>
                <div class="u-form-group u-form-password u-label-top">
                  <label for="password-a30d" class="u-label u-text-custom-color-3 u-label-2">Heslo</label>
                  <input type="text" placeholder="Zadejte heslo" id="password-a30d" name="password" class="u-border-2 u-border-grey-10 u-grey-10 u-input u-input-rectangle u-input-2" required="">
                </div>
                <div class="u-form-checkbox u-form-group u-label-top">
                  ...
                  <label for="checkbox-a30d" class="u-block-f758-14 u-field-label u-text-custom-color-3" style="font-size: 1rem; letter-spacing: 0px; text-transform: none">Zapamatovat si mě</label>
                </div>
                <div class="u-align-left u-form-group u-form-submit u-label-top">
                  <input type="submit" value="submit" class="u-form-control-hidden">
                  <a href="#" class="u-active-custom-color-2 u-border-none u-btn u-btn-submit u-button-style u-custom-color-1 u-hover-custom-color-2 u-btn-1">Login</a>
                </div>
